...
<div id="log">
        ...
        <%
            ...
            session.setAttribute("name",ret_name);
            ...
            if(present==0)
            {
              ...
              <br><br>
                <center><div class="mx-auto" style="width: 1000px;">
                        ...
                        <h1 class="panel-title"><center><font size="5" face="Courier new"><%out.print(ret_name);%></font><br><font size="4" face="courier new"></font></center></h1></h1></div>
                        <div class="panel-body">
                        <font size="4" face="courier new"><b>NOT ISSUED ANY BOOK</b></font>
                        <br>
                        <a href="login.jsp"><button class="btn btn-danger"><font size="4" face="courier new"><b>LOGIN</b></font> </button></a>
                        </div></div></div></center>
                        <%
