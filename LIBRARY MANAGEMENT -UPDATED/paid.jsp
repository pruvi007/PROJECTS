...
<div id="log">
       ...
       <!--- NAVBAR and TEAM INFO -->
        ...
        String book[] = request.getParameterValues("return");
        String first = (String)(session.getAttribute("name"));
        //out.print(first);
        int flag[] = new int[book.length];
        for(int i=0;i<book.length;i++)
        {
            stmt.executeUpdate("delete from "+first+" where NAME = '"+book[i]+"'");
        ...
        for(int i=0;i<book.length;i++)
        {
              ...
              prep = connection.prepareStatement("update BOOKS set rem = rem + 1 where NAME=?");
              prep.setString(1,book[i]);
              prep.executeUpdate();
        ...
        <div class="mx-auto" style="width: 800px;">
                        ...
                        <h1 class="panel-title"><center><font size="5" face="Courier new"><b>RETURNED</b></font><br><font size="4" face="courier new"></font></center></h1></h1></div>
                        <div class="panel-body">
        <img src="smile.jpeg" class = "img-responsive" height="50%" width="50%"/><br>
        <font size="4" face="courier new"><b>SUCCESSFULLY RETURNED<br>UPDATED.</b></font>



        <div id="img4">
          <button id="btn4"  class = "btn btn-danger" data-toggle="modal" data-target="#myModal444" >
                    <font size="4" face="courier new">VIEW YOUR BOOKS</font>
          </button>
          </div>
...
</center></td></tr></center></th></tr></table></div></div></div></div></div></div></div></center>
<br><br>
<div class="footer">
            ...
            <%
              prep = connection.prepareStatement("insert into LOG values(?,?)");
                        ...
                        String ev = "BOOK RETURNED BY "+first;
                         prep.setString(2,ev);
                        prep.executeUpdate();
