...
<center><div class="mx-auto" style="width: 1000px;">
                        ...
                        <h1 class="panel-title"><h1><center> <h1><b>LOG TABLE</b></h1></center></h1></h1></div>
                        ...
                        <tr class="active">
                          ...
                          <td><font size="4" face="courier new"><b><%out.print(c++);%></b></font></td>
                           <td><font size="4" face="courier new"><b><%out.print(time);%></b></font></td>
                            <td><font size="4" face="courier new"><b><%out.print(event);%></b></font></td>
                            </tr>
                            <%
                        }
