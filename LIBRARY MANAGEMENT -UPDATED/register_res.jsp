 ...
 <div id="log">
      ...
      <%
            stmt = connection.createStatement();
             ...
             while(res.next())
             {
                        String exist = res.getString(1);
                        exist=exist.toUpperCase();
                        if(first.equals(exist))
                        {
                              f=1;
                              break;
                        }
            ...
            if(f==0)
            {
                        res = stmt.executeQuery("select count(ID) from STUDENT");
                              res.next();
                              int c = res.getInt(1);
                              prep = connection.prepareStatement("insert into STUDENT values(?,?,?,?,?,?,?)");
                              prep.setInt(1,(c+100));
      ...
      <div class="mx-auto" style="width: 1000px;">
                        ...
                        <h1 class="panel-title"><h1><center><h1>STUDENT</h1></center></h1></h1></div>
                        <div class="panel-body">


                        <img src="smile.jpeg" height="50%" width="50%"/><br>
            
            <font size="4" face="courier new"><b>SUCCESSFULLY ADDED</b></font><br>
      ...
      <%
            ...
            else
            {
                  %>
                         ...
                         <div class="panel panel-primary">
                        <div class="panel-heading">
                        <h1 class="panel-title"><h1><center><h1>ALREADY EXISTS</h1></center></h1></h1></div>
                        <div class="panel-body">
                        <img src="sad.gif" class="img-responsive"/>
                        <font size="4" face="courier new">USER ALREADY EXISTS<br></font>
                        <a href ="login.jsp"><button class="btn btn-danger"><font size="4" face="courier new">LOGIN</font></button></a>
